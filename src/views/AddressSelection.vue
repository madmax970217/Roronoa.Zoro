<template>
  <div>
    <el-button @click="showMapComponent = true">获取位置</el-button>
    <el-dialog
      slot="—"
      :title="title"
      :width="width"
    ...
    >
      <baidu-map
        :style="mapStyle"
        ak="k1k1eBxFKqTHDSw2LPvqsud9il3Oubjz"
        :map-click="false"
        :center="center"
        :zoom="zoom"
...
<script
  ...
  src="https://api.map.baidu.com/api?v=2.0&ak=k1k1eBxFKqTHDSw2LPvqsud9il3Oubjz"
></script>
<script>
import {
  BaiduMap,
